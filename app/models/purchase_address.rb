class PurchaseAddress
  ...
  attr_accessor :postal_code, :delivery_area_id, :municipalities, :house_number, :building, :phone, :item_id, :user_id,:token, :price
  ...
  with_options presence: true do
    ...
    validates :municipalities, :house_number, :user_id, :item_id,:token, :price
